...
\firstname{Joaquín} % Your first name
\familyname{García} % Your last name
...
\cventry{2009--2010}{Tecnicatura en Redes y Telecomunicaciones}{UTU - Instituto Tecnólogico Superior}
\cventry{2006--2009}{Bachillerato Tecnólogico en Informática}{UTU - Instituto Tecnólogico Superior}

\section{Proyecto fin de grado - Tecnicatura en Telecomunicaciones}

\cvitem{Titulo}{\emph{Implementación de Software Defined Networking por medio del protocolo OpenFlow}}
\cvitem{Tutor}{Catherine Sonderegger}
\cvitem{Descripción}{This thesis explored the idea that money has been the cause of untold anguish and suffering in the world. I found that it has, in fact, not.}
...
\cvitemwithcomment{Inglés}{Intermedio}{Conversationally fluent}
